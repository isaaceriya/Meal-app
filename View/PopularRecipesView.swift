    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            ScrollView(.horizontal,  showsIndicators: false, content: {
                ...
                .padding(.horizontal) // This is what shows the popular recipes.
            })
        }
        .onAppear {
            viewModel.fetchData()
                    ...
                    HStack {
                        HStack {
                            Image(systemName: "star.fill")
                                .foregroundColor(.yellow) // Adds the stars rating
                            
                            Text("4.7")
                                .fontWeight(.bold)
                                .foregroundColor(.white)
                                .redacted(reason: recipe.strMeal == nil ? .placeholder : .init()) // adds the number next to the stars.
                        }
                        .padding(6)
